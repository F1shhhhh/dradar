"""Pier adapter for DeepSeek's official Codex model catalog.
...
turn and trajectory collection to Pier's stock Codex adapter.
"""
...
class DeepSeekCodex(Codex):
    """Stock Codex plus a fail-closed DeepSeek catalog."""
