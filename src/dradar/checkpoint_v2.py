...
MAX_PROTOCOL_OBJECT_BYTES = 32 * 1024
...
class UsageSegmentEvidenceV2:
    ...
    def protocol_fields(
        ...
        if not isinstance(self.events, tuple) or len(self.events) > 128:
...
class CheckpointV2Journal:
    ...
    def begin(self, command: str, payload: Mapping[str, Any]) -> JournalEntry:
        ...
        with assignment_lock(self.home, assignment_id):
            if path.exists():
    ...
    def _transition(
        ...
        *,
        ...
        with assignment_lock(self.home, current.assignment_id):
